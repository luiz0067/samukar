...
include('conecta.php');
	...
	$result=null;
	if (isset($_GET["id"])){
		$sql	= "SELECT id,titulo,imagem,id_categoria,id_sub_categoria,obs,valor,marca,modelo,combustivel,cor,opcionais FROM imagem where (id=0".$_GET["id"].")";
		...
		<div id="input_cadastro">
			...
			<select name="id_sub_categoria" <?php if ($result!=null) echo $row["id_sub_categoria"]?>>
					...
					<div class="tudo_input">
						...
						<div class="left_input">
							<input name="valor" style="width:530px;" type="text" value="<?php echo $row["valor"]?>">
						</div>
						<div class="clear"></div>
					</div>
					...
					<div class="tudo_input">
						...
						<div class="left_input">
							<input name="marca" style="width:530px;" type="text" value="<?php echo $row["marca"]?>">
						</div>
						<div class="clear"></div>
					</div>
					<div class="tudo_input">
						...
						<div class="left_input">
							<input name="modelo" style="width:530px;" type="text" value="<?php echo $row["modelo"]?>">
						</div>
						<div class="clear"></div>
					</div>	
					<div class="tudo_input">
						...
						<div class="left_input">
							<input name="combustivel" style="width:530px;" type="text" value="<?php echo $row["combustivel"]?>">
						</div>
						<div class="clear"></div>
					</div>
					<div class="tudo_input">
						...
						<div class="left_input">
							<input name="cor" style="width:530px;" type="text" value="<?php echo $row["cor"]?>">
						</div>
						<div class="clear"></div>
					</div>
					<div class="tudo_input">
						...
						<div class="left_input">
							<input name="opcionais" style="width:530px;" type="text" value="<?php echo $row["opcionais"]?>">
						</div>
						<div class="clear"></div>
					</div>
					<div class="tudo_input">
				...
				<?php
					if ($_POST) {
						...
						if ($_POST['acao']=='Excluir'){
							$sql = 'delete FROM imagem where id='.$_POST["id"];
							   if($sql){
	  ...
	  <div id="relatorio_input" >
		<table cellpadding= "4" cellspacing = "0" border= "1" width="1004">
			...
			?>
				<tr>
					<td>
					<a href="principal.php?pg=cadastro_imagem&id=<?php echo $row['id'];?>" VALUE="EDITAR" NAME="EDITAR">
					...
					<td><?php echo $row['marca'];?>&nbsp </td>
					<td><?php echo $row['modelo'];?>&nbsp </td>
					<td><?php echo $row['combustivel'];?>&nbsp </td>
					<td><?php echo $row['cor'];?>&nbsp </td>
					<td><?php echo $row['opcionais'];?>&nbsp </td>
