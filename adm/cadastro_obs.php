...
include('conecta.php');
	...
	$result=null;
	if (isset($_GET["id"])){
		$sql	= "SELECT id,titulo,obs,imagem FROM obs where (id=0".$_GET["id"].")";
			...
			<div class="divisor">
				...
				<?php
					if ($_POST) {
						...
						$sql = "insert into obs (imagem,titulo,obs) values ('".$imagem."','".$_POST["titulo"]."','".$_POST["obs"]."');";
						echo $sql;
						...
						if ($_POST['acao']=='Excluir'){
							$sql = 'delete FROM obs where id='.$_POST["id"];
							   if($sql){
							...
							$sql = "update obs set imagem='".$imagem."',titulo='".$_POST["titulo"]."',obs='".$_POST["obs"]."' where (id=".$_POST["id"].");";
							//echo $sql;
							if($sql){
