...
include('conecta.php');
	...
	$result=null;
	if (isset($_GET["id"])){
		$sql	= "SELECT id,titulo,imagem FROM imagem where (id=0".$_GET["id"].")";
			...
			<div class="divisor">
				...
				<?php
					if ($_POST) {
						...
						$sql = "insert into imagem (imagem,titulo) values ('".$imagem."','".$_POST["titulo"]."');";
						echo $sql;
						...
						if ($_POST['acao']=='Excluir'){
							...
							$sql = "update imagem set imagem='".$imagem."',titulo='".$_POST["titulo"]."' where (id=".$_POST["id"].");";
							//echo $sql;
							if($sql){
